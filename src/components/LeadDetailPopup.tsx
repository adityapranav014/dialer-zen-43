                ...
                <div className="pointer-events-auto w-full sm:max-w-xl md:max-w-2xl lg:max-w-3xl bg-card border border-border rounded-t-2xl sm:rounded-2xl shadow-2xl max-h-[90vh] sm:max-h-[85vh] flex flex-col animate-in slide-in-from-bottom-4 sm:slide-in-from-bottom-2 duration-300">
                            ...
                            <div className="flex items-center gap-3.5 min-w-0">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="flex items-center gap-2 mt-1 flex-wrap">
                                        <span className={`inline-flex items-center gap-1.5 text-[10px] sm:text-[11px] font-semibold px-2.5 py-1 rounded-full border ${sc.bg} ${sc.color} ${sc.border}`}>
                    ...
                    <div className="flex-1 overflow-y-auto scroll-container px-5 sm:px-6 py-5 space-y-5">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                            {/* Phone */}
                            <button onClick={handleCopy} className="flex items-center gap-2.5 p-3 rounded-xl bg-muted/60 border border-foreground/[0.04] hover:border-foreground/10 transition-all group text-left">
                                ...
                                <div className="min-w-0 flex-1">
                                    <p className="text-[9px] font-medium text-foreground/30 uppercase tracking-wider">Phone</p>
                                    <p className="text-[11px] sm:text-xs font-semibold text-foreground truncate">{lead.phone}</p>
                                </div>
                            ...
                            {/* Created */}
                            <div className="flex items-center gap-2.5 p-3 rounded-xl bg-muted/60 border border-foreground/[0.04]">
                                ...
                                <div className="min-w-0">
                                    <p className="text-[9px] font-medium text-foreground/30 uppercase tracking-wider">Created</p>
                                    <p className="text-[11px] sm:text-xs font-semibold text-foreground">{age}d ago</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5 p-3 rounded-xl bg-muted/60 border border-foreground/[0.04]">
                                ...
                                <div className="min-w-0">
                                    <p className="text-[9px] font-medium text-foreground/30 uppercase tracking-wider">Calls</p>
                                    <p className="text-[11px] sm:text-xs font-semibold text-foreground">{totalCalls}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2.5 p-3 rounded-xl bg-muted/60 border border-foreground/[0.04]">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-[11px] sm:text-xs font-semibold text-foreground">{formatDuration(avgCallDuration)}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* ── Assigned BDA ─────────────────────────────────────── */}
                        {lead.assignedTo ? (
                            <div className="p-3.5 rounded-xl bg-muted/40 border border-foreground/[0.04]">
                                <p className="text-[9px] font-semibold uppercase tracking-wider text-foreground/30 mb-2.5">Assigned To</p>
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <p className="text-xs font-semibold text-foreground">{lead.assignedTo}</p>
